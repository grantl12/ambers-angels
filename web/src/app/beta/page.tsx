          ...
          <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-8 flex flex-col">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <span className="text-xs text-white/30">via Google Play Testing</span>
              </div>
            </div>

            <div className="space-y-4 flex-1">
              <Step n={1}>
                <span>Tap the link below on your Android phone. You&apos;ll be asked to
                opt in to the testing program — tap <strong className="text-white/80">&ldquo;Accept.&rdquo;</strong></span>
              </Step>
              <Step n={2}>
                <span>Once opted in, the Google Play Store listing will appear.
                Tap <strong className="text-white/80">&ldquo;Install&rdquo;</strong> — no sideloading,
                no special settings.</span>
              </Step>
              <Step n={3}>
                <span>Open the app, create an account, and start scanning.</span>
              </Step>
            </div>

            <a
              href="#"
              className="mt-8 block text-center py-3 px-6 rounded-lg bg-[#3ddc84] text-black font-bold text-sm hover:bg-[#5ae89c] transition-colors"
            >
              Join Android Beta →
            </a>
            <p className="mt-3 text-xs text-white/25 text-center">
              Requires Android 13+. Opens Google Play on your phone.
            </p>
          </div>
        </div>
